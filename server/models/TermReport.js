...
const termReportSchema = new mongoose.Schema({
  ...
  activeFileTotal: { type: Number, default: 0 },
  fixTotal: { type: Number, default: 0 },
  totalCodingDurationMinutes: { type: Number, default: 0 },
  totalFeedCount: { type: Number, default: 0 },
  totalWaterCount: { type: Number, default: 0 },
  totalCareActionCount: { type: Number, default: 0 },
